...
# dtype = {'indexno':int,'SYMBOL':str,'SERIES':str,'OPEN':float,'HIGH':float,'LOW':float,'CLOSE':float,'LAST':float,'PREVCLOSE':float,'TOTTRDQTY':float,'TOTTRDVAL':float,'TIMESTAMP':str,'TOTALTRADES':float,'ISIN':str}
